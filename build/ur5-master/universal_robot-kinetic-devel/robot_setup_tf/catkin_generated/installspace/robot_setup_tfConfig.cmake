...
if("FALSE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/us-robot/catkin_ws/src/ur5-master/universal_robot-kinetic-devel/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/us-robot/catkin_ws/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/us-robot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jzhang <jzhang@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/us-robot/catkin_ws/install/${idir}'.  Ask the maintainer 'jzhang <jzhang@todo.todo>' to fix it.")
    endif()
